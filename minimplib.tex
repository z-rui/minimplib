...
\ifx\newcatcodetable\undefined
  \chardef\mp@catcode=1 % too bad! we don't have ltluatex
  \savecatcodetable\mp@catcode
\else
  \let\mp@catcode=\catcodetable@atletter
\fi

{\catcodetable\mp@catcode \directlua{require('minimplib')}}
